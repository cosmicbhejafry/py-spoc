...
from coranking_auxiliary_functions import ranking_matrix, coranking_matrix, compute_trustworthiness, compute_auc_T
from sklearn.metrics import pairwise_distances
from pyspoc import ReducedStatistic


class Trustworthiness(ReducedStatistic):
    ...
    def compute(self, data: np.ndarray) -> float:
        ...
        # Compute Trustworthiness and take the AUC (average in this case)
