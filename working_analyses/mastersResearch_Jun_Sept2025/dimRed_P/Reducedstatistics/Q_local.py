import numpy as np
import umap
from coranking_metrics import ranking_matrix, coranking_matrix, slice_Q, compute_QNN, compute_LCMC, compute_kmax, compute_Qlocal
...
class Q_local(ReducedStatistic):
    ...
    def compute(self, data: np.ndarray) -> Union[np.ndarray, float]:
        ...
        # Compute QNN, LCMC, kmax and finally Qlocal
        QNN = compute_QNN(Q)
