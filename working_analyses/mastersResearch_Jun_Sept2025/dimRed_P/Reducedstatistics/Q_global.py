import numpy as np
import umap
from coranking_auxiliary_functions import ranking_matrix, coranking_matrix, slice_Q, compute_QNN, compute_LCMC, compute_kmax, compute_Qglobal
...
class Q_global(ReducedStatistic):
    ...
    def compute(self, data: np.ndarray) -> Union[np.ndarray, float]:
        ...
        # Compute QNN, LCMC, kmax and finally Qglobal
        QNN = compute_QNN(Q)
